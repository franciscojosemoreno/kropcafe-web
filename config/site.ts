export const siteConfig = {
  ...
  locations: [
    ...
    },
    {
      ...
      address: 'Vía Viva, Barrio Chino',
      neighborhood: 'Belgrano, Buenos Aires',
      mapsUrl: 'https://www.google.com/maps/place/KROP+CAFE+VIAVIVA/@-34.5561306,-58.4534763,17z',
      mapSrc: 'https://maps.google.com/maps?q=-34.5561306,-58.4534763&output=embed',
      hours: 'Lun–Vie 8–20h · Sáb–Dom 9–20h',
      whatsapp: null,
      whatsappLabel: null,
    },
